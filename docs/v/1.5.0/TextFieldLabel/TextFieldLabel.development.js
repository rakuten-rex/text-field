...
/* harmony import */ var _TextFieldLabel_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
...
function TextFieldLabel(_ref) {
  var name = _ref.name,
      ...
      props = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_1___default()(_ref, ["name", "placeholder", "className", "label", "htmlFor", "labelId", "state", "style", "disabled", "value", "required", "inputRef"]);
  ...
  var disabledState = disabled ? 'disabled' : '';
  var classes = ['rex-text-field-label', className, stateClass, disabledState].filter(function (singleClass) {
    return singleClass && singleClass.length > 0;
  }).join(' ').trim();
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    disabled: disabled,
    required: required
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_TextFieldUi__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
    id: htmlFor,
    labelId: labelId,
    name: name,
    placeholder: placeholder,
