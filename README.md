...
```
npm install @rakuten-rex/text-field@1.4.0 --save
```

<img src="project-scripts/webpack/markdown/logos/yarn.svg?sanitize=true" height="16" />

```
yarn add @rakuten-rex/text-field@1.4.0
```
...
```
https://unpkg.com/@rakuten-rex/text-field@1.4.0/TextFieldLabel/TextFieldLabel.production.min.css
```
...
```
https://unpkg.com/@rakuten-rex/text-field@1.4.0/TextFieldLabel/TextFieldLabel.development.css
```
...
```
https://unpkg.com/@rakuten-rex/text-field@1.4.0/TextFieldLabel/TextFieldLabel.static.css
```
...
<html>
  <head>
    ...
    <title>My Page</title>
    <!-- ReX text-field -->
    <link href="https://unpkg.com/@rakuten-rex/text-field@1.4.0/TextFieldLabel/TextFieldLabel.production.min.css" rel="stylesheet">
  </head>
  <body>
    <div class="rex-my-component" role="presentation">
      <div class="rex-text-field-label" id="age">
